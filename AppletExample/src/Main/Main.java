...
public class Main {
    ...
    public void createGame(){
        ...
        arregloPropiedadades[1] = new Propiedades(60, "", 465,500,0,0,0,0,10,30,"Wikipedia", "PROPIEDAD",100,200,300,300);
        ...
        arregloPropiedadades[6] = new Propiedades(120, "", 180,500,0,0,0,0,50,60,"Blogspot", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[7] = new Propiedades(130, "", 120,500,0,0,0,0,65,65,"JotSpot", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[8] = new Propiedades(0, "", 65,500,0,0,0,0,0,0,"Dead Pool", "CARCEL",0,0,0,0);
        arregloPropiedadades[9] = new Propiedades(210, "", 40,410,0,0,0,0,100,105,"Youtube", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[10] = new Propiedades(210, "", 40,360,0,0,0,0,100,105,"Twitter", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[11] = new Propiedades(0, "", 40,300,0,0,0,0,0,0,"Google Adworks", "LEERCARTA",0,0,0,0);
        arregloPropiedadades[12] = new Propiedades(220, "", 40,240,0,0,0,0,100,110,"Wordpress", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[13] = new Propiedades(240, "", 40,180,0,0,0,0,110,120,"Facebook", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[14] = new Propiedades(250, "", 40,120,0,0,0,0,120,125,"Instagram", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[15] = new Propiedades(75, "", 40,50,0,0,0,0,0,0,"Google Foundation", "DONACION",0,0,0,0);
        arregloPropiedadades[16] = new Propiedades(260, "", 120,35,0,0,0,0,195,130,"LinkedIn", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[17] = new Propiedades(0, "", 180,35,0,0,0,0,0,0,"I'm feeling lucky", "LEERCARTA",0,0,0,0);
        arregloPropiedadades[18] = new Propiedades(260, "", 235,35,0,0,0,0,195,130,"FOURSQUARE", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[19] = new Propiedades(225, "", 295,35,0,0,0,0,100,110,"Paypal", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[20] = new Propiedades(15, "", 350,35,0,0,0,0,0,0,"Impuestos Servidor", "IMPUESTOS15",0,0,0,0);
        arregloPropiedadades[21] = new Propiedades(300, "", 405,35,0,0,0,0,190,150,"Skype", "PROPIEDAD",100,200,300,300);
        ...
        arregloPropiedadades[24] = new Propiedades(380, "", 540,120,0,0,0,0,210,190,"Ebay", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[25] = new Propiedades(75, "", 540,185,0,0,0,0,0,0,"Developer Platform", "BONUSDEV",0,0,0,0);
        arregloPropiedadades[26] = new Propiedades(400, "", 540,240,0,0,0,0,310,200,"Amazon", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[27] = new Propiedades(0, "", 540,300,0,0,0,0,0,0,"I[m feeiling lucky", "LEERCARTA",0,0,0,0);
        arregloPropiedadades[28] = new Propiedades(480, "", 540,355,0,0,0,0,350,240,"Oracle", "PROPIEDAD",100,200,300,300);
        arregloPropiedadades[29] = new Propiedades(500, "", 540,415,0,0,0,0,400,250,"Microsoft", "PROPIEDAD",100,200,300,300);
        ...
        preguntas[4] = new Preguntas("Has visitado google, resibiras $35 por contribuirnos.",35,"Ganar","");
